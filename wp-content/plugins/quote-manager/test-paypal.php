<?php
	...
	*/
	...
	function PPHttpPost($methodName_, $nvpStr_)
	{
	 ...
	 $API_UserName = urlencode('eric_api1.rosasfreelancedesign.com');
	 $API_Password = urlencode('Z5TR5PV2BRGBTQ75');
	 $API_Signature = urlencode('AS17WbKNekr9rJtGEywMLqHUWHvIA7kekZTmR656K-hof0EsBMGnVX6v');
