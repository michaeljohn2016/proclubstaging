...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'proclubs' ); ?></h2>
	...
	wds_proclubs_display_scaffolding_section(
		[
			...
			'usage'       => '<del>Pro Clubs Theme</del>',
			'output'      => '<p>We use <del>Pro Clubs Theme</del> wd_s to build themes.</p>',
		]
	);
